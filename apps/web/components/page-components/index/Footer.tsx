...
function Footer() {
  return (
    <footer className="overflow-hidden z-10 mx-auto flex py-8 px-16 xl:px-24 justify-between footer bg-background/30 relative mb-6 max-w-7xl rounded-2xl shadow-sm saturate-100 backdrop-blur-[10px]">
      <aside>
        <svg
          width="50"
          height="50"
