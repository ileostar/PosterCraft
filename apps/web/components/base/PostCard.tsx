...
const PostCard: React.FC = () => {
  ...
  return (
    <div className="mt-36 xl:w-[24%] sm:w-[49%] md:w-[32%] w-full relative flex flex-col rounded-xl saturate-100 backdrop-blur-[10px] bg-clip-border text-gray-700 shadow-md shadow-gray-300/50">
