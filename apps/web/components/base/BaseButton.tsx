...
const BaseButton: React.FC<BaseButtonProps> = ({ children, className }) => {
  return (
    <button
      className={`relative shadow-md duration-500 group cursor-pointer  overflow-hidden h-12 w-40 text-white rounded-lg bg-sky-800/50 p-2 flex justify-center items-center font-extrabold ${className}`}
    >
